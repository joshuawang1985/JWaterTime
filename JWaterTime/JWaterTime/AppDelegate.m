...
- (void)setupTabBarController
{
    ...
    YALFoldingTabBarController *mainTabBarController = (YALFoldingTabBarController *)self.window.rootViewController;
    ...
    mainTabBarController.leftBarItems = @[item1, item2];
    ...
    mainTabBarController.rightBarItems = @[item3,item4];
    
    mainTabBarController.centerButtonImage = [UIImage imageNamed:@"plus_icon"];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "Joshua.JWaterTime" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"JWaterTime" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"JWaterTime.sqlite"];
    NSError *error = nil;
